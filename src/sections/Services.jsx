  ...
  return (
    <section className='relative lg:px-10 md:px-10 p-0'>
      <Element name="services">
        <div
          className='flex lg:pt-16 md:pt-16 pt-6 mb-12'
        >
        ...
        <h1
          className='lg:text-5xl text-white md:text-4xl text-3xl lg:leading-[60px] md:leading-[45px] leading-[36px] mt-12 mb-10 max-w-[670px] font-light'
        >
          My <span className='text-red'>Services</span>
        </h1>
        <div className='flex flex-col items-center gap-10 mt-10'>
          {service.map(({ icon, title, content, id }) => (
            <div
              key={id}
              className="flex flex-col items-start p-6 border-[1px] border-[#cecec8] hover:border-red hover:text-red rounded-2xl"
              data-aos="fade-up" 
            >
